 ...
 *
 *  Implements Percolation Stats API running Monte-carlo simulation on Percolation datatype
 *
	...
	public static void main(String[] args) {
		...
		if (args.length == 2) {
			try {
				...
				StdOut.println("Invalid command line arguments. Proceeding with application defaults");
			}
		}
